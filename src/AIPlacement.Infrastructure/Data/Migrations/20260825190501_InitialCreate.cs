...
namespace AIPlacement.Infrastructure.Data.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobMatchScore", x => x.MatchId);
                    table.ForeignKey(
                        name: "FK_JobMatchScore_JobDrives_JobDriveId",
                        column: x => x.JobDriveId,
                        principalTable: "JobDrives",
                        principalColumn: "JobDriveId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobMatchScore_Resumes_ResumeId",
                        column: x => x.ResumeId,
                        principalTable: "Resumes",
                        principalColumn: "ResumeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobMatchScore_StudentProfiles_StudentId",
                        column: x => x.StudentId,
                        principalTable: "StudentProfiles",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlacementResult", x => x.PlacementId);
                    table.ForeignKey(
                        name: "FK_PlacementResult_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "ApplicationId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PlacementResult_JobDrives_JobDriveId",
                        column: x => x.JobDriveId,
                        principalTable: "JobDrives",
                        principalColumn: "JobDriveId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PlacementResult_StudentProfiles_StudentId",
                        column: x => x.StudentId,
                        principalTable: "StudentProfiles",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AIRecommendations_JobMatchScore_MatchId",
                        column: x => x.MatchId,
                        principalTable: "JobMatchScore",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SkillGap_JobMatchScore_MatchId",
                        column: x => x.MatchId,
                        principalTable: "JobMatchScore",
                        principalColumn: "MatchId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SkillGap_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "SkillId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobMatchScore_JobDriveId",
                table: "JobMatchScore",
                column: "JobDriveId");

            migrationBuilder.CreateIndex(
                name: "IX_JobMatchScore_ResumeId",
                table: "JobMatchScore",
                column: "ResumeId");

            migrationBuilder.CreateIndex(
                name: "IX_JobMatchScore_StudentId",
                table: "JobMatchScore",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlacementResult_ApplicationId",
                table: "PlacementResult",
                column: "ApplicationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PlacementResult_JobDriveId",
                table: "PlacementResult",
                column: "JobDriveId");

            migrationBuilder.CreateIndex(
                name: "IX_PlacementResult_StudentId",
                table: "PlacementResult",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillGap_MatchId",
                table: "SkillGap",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillGap_SkillId",
                table: "SkillGap",
                column: "SkillId");
